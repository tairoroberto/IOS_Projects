...
class MoviesTableViewController: UITableViewController {
    ...
    var fetcheResultsController: NSFetchedResultsController<Movie>!
    ...
    //prepara para enviar para outra tela
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let vc = segue.destination as? MovieViewController {
            vc.movie = fetcheResultsController.object(at: tableView.indexPathForSelectedRow!)
        }
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if let count =  fetcheResultsController.fetchedObjects?.count {
            return count
        }else{
            return 0
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let movie = fetcheResultsController.object(at: indexPath)
